...
// Base URL ML from env or default to local development
// For local testing: http://localhost:8001 (changed from 8000)
// For production: https://capstone-protek-production.up.railway.app
const ML_API_URL = (process.env.ML_API_URL || 'http://localhost:8000').replace(/\/$/, '');

console.log(`\n🔧 [Simulation Controller] ML API URL: ${ML_API_URL}\n`);
